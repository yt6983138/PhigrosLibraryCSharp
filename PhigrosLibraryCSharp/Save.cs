...
/// </summary>
public class Save // TODO: Rearrange the code to make it more readable
{
	#region Constants
	...
	/// <see cref="LCHelper.LoginAndGetToken(Cloud.Login.DataStructure.LCCombinedAuthData, bool, bool)"/>.</param>
	...
	public async Task<SaveSummaryPair> GetGameSaveAsync( // TODO: Add a way to download just once when all data is required
