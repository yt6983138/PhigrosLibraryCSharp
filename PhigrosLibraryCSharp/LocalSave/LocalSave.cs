...
/// <summary>
/// A class for processing local save data.
/// </summary>
public static class LocalSave
{
	private static readonly byte[] sBox =
	// generated by ai, has been verified to be correct
	[
	...
	private static readonly byte[] initialVector = [190, 86, 22, 127, 131, 218, 59, 239, 239, 248, 24, 97, 165, 197, 243, 205];
	...
	private static readonly byte[] tempArray = [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3];
	...
	{
		byte[] tempState = UtilityExtension.QuickCopy(state);
		for (byte i = 0; i < 16; i++)
		{
